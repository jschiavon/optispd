...
man = SPD(p + 1)
optim_rep = OPTIM(man, method='rcg', bethamethod='hybridhsdy', maxiter=maxiter, mingradnorm=tol, verbosity=1, logverbosity=False)
optim_rep_rsd = OPTIM(man, method='rsd', maxiter=maxiter, mingradnorm=tol, verbosity=0, logverbosity=False)
